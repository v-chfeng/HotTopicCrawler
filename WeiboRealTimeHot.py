...
if __name__ == '__main__':
    ...
    keywords_css = ['.star_name a', 'string']
    urls_css = ['.star_name a', 'href']
    hotindex_css = ['.star_num span', 'string']

    weibo_realtime_url = 'http://s.weibo.com/top/summary?cate=realtimehot'
    ...
    if not Is_Crawled_Today:        
        bangdan_crawler = HotTopicCrawler.crawler(weibo_realtime_url, temp_outpath)
        (results_list, results_dic) = bangdan_crawler.custom_run(keywords=keywords_css, urls=urls_css, hotindex=hotindex_css)
        new_results_list = []
